...
class metadata
{
    public function __construct()
    {
        ...
        add_action( 'rest_api_init', function () {
            ...
            register_rest_field( 'blog', 'imageURL', array(
                'get_callback' => function( $post_arr ) {
                    return get_the_post_thumbnail_url( $post_arr['id'], 'thumbnail' );
                },
            ) );

            register_rest_field( 'blog', 'imageWidth', array(
                'get_callback' => function( $post_arr ) {
            ...
            register_rest_field( 'blog', 'imageHeight', array(
                'get_callback' => function( $post_arr ) {
                    $img = wp_get_attachment_image_src(get_post_thumbnail_id($post_arr['id']), 'thumbnail');
                    return $img[2];
                },
         ...
         */
        add_filter( 'rest_blog_collection_params', function( $query_params ) {
