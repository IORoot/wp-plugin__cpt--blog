...
class youtube_links_to_embeds {
    ...
    {
        add_filter('cpt_blog_transforms', [$this, 'callback'], 50, 1 );
    }
    ...
    public function callback($text)
    {
        ...
        {
            $embed  = '<lite-youtube class="aspect-w-16 aspect-h-9 relative bg-repeat-none bg-cover bg-center my-12 fill-yellow-500 cursor-pointer flex" videoid="'.$match.'">';
